...
export default function NotFoundPage() {
    ...
    return (
        <div id='notFoundPage' className='w-screen h-screen text-center bg-pink-100'>
            <img className='w-1/3 mx-auto' src='./image/notfoundImg2.svg' alt='404' />
            <h1 className='font-bold text-pink-600 text-5xl'>PAGE NOT FOUND</h1>
            <p className='my-5 text-xl uppercase font-bold'> The page you requested could not be found</p>
