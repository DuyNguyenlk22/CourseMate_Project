    ...
    return (
        <div className='lg:ml-10 mt-10'>
            ...
            <div className="text-right">
                <p className='lg:text-xl w-1/2 md:w-full text-sm lg:p-10 py-4'>View Other Courses of Educator at <span className='cursor-pointer font-semibold underline text-purple-900'
